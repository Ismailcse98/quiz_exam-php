...
<div id="warning" class="p-3 mb-4 bg-danger text-white text-center">Don't Enter the cursor into the danger zone.</div>
<div class="content-section">
    <div class="container">
        ...
        <?php
            ...
            $chapter = "SELECT * FROM chapter_list WHERE chapter_name = 'Concepts of IT'";
        ...
        <h4 class="subject-name">Welcome <span style="color:#FF5722"><?php echo $login_name." - ".$login_id?></span> ( <?php echo $chapter_name;?> )</h4>
            <ul class="nav justify-content-center bg-dark">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="#"><h5>Question : 20</h5></a>
                </li>
            </ul>
        </div>
...
<?php
    ...
    error_reporting(0);
        ...
        $query = "SELECT * FROM concepts_of_it";
        ...
        $wrong_ans = 20 - $i;
        $Total_mark = $i * 2;
        $insertQuery = "INSERT INTO result (chapter,name,student_id,correct_ans, wrong_ans, total_mark ) VALUES ('concepts of it','$name','$stu_id','$i','$wrong_ans','$Total_mark')";

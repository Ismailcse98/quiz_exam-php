...
<div class="content-section">
    <div class="container">
        ...
        <?php
            ...
            $chapter = "SELECT * FROM chapter_list WHERE chapter_name = 'Windows 10'";
...
<?php
    ...
    error_reporting(0);
        ...
        $wrong_ans = 20 - $i;
        $Total_mark = $i * 2;
        $insertQuery = "INSERT INTO result (chapter,name,student_id,correct_ans, wrong_ans, total_mark ) VALUES ('Windows 10','$name','$stu_id','$i','$wrong_ans','$Total_mark')";

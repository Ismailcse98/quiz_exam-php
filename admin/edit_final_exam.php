...
?>
    ...
    ?>
                <div class="col-md-9">
                        <h2>Update Final Exam Question</h2>
                        <?php
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM final_exam WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_final_exam_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_final_exam" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }

...
?>
    ...
    ?>
                <div class="col-md-9">
                        <h2>Update Windows 10 Question</h2>
                        <?php
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM windows_10 WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_windows_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_windows" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }

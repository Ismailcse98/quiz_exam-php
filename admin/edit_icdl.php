...
?>
    ...
    ?>
                <div class="col-md-9">
                        <h2>Update ICDL Exam Question</h2>
                        <?php
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM icdl WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_icdl_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_icdl" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }

    ...
    ?>
                <div class="col-md-9">
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM concepts_of_it WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_concept_it_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_concept_it" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }

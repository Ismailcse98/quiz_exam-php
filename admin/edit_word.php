...
?>
    ...
    ?>
                <div class="col-md-9">
                        <h2>Update MS Word 2016  Exam Question</h2>
                        <?php
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM ms_word_16 WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_word_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_word" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }

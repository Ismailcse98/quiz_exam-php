...
?>
    ...
    ?>
                <div class="col-md-9">
                        <h2>Update MS Excel 2016 Question</h2>
                        <?php
                    ...
                    <?php
                        ...
                        $res = "SELECT * FROM ms_excel_16 WHERE id ='$id'";
                        $run = mysqli_query($link, $res);
                        if($run) {
                            $sl = 1;
                            while($question = mysqli_fetch_array($run)) {
                    ?>
                                <form action="edit_excel_core.php" method="POST">
                                    ...
                                    <br>
                                    <input type="submit" name="edit_excel" value="Update Question" class="form-control" style="background:#FF5722">
                                    <br>
                                </form>
                        <?php
                             }
